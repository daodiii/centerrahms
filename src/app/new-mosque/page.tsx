      ...
      <header className="mb-8 relative w-full">
        <div className="relative w-full overflow-hidden rounded-b-2xl">
          <Image
            ...
            priority
          />
          {/* Title overlaid on the gray area at the top of the image */}
          {/* Light wash behind text for contrast */}
          ...
          <div className="absolute top-0 left-0 right-0 flex flex-col items-center justify-center pt-6 pb-4 sm:pt-10 sm:pb-6 md:pt-14 md:pb-8">
            <p className="text-[10px] sm:text-xs tracking-[0.3em] uppercase font-[family-name:var(--font-jakarta)] font-medium text-gray-700 mb-2 sm:mb-3">
              Fremtidens moské
            </p>
            <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-semibold tracking-tight leading-[1.1] font-[family-name:var(--font-display)] text-center text-gray-900">
              Nye Masjid Rahma
            </h1>
            <p className="font-[family-name:var(--font-jakarta)] text-gray-950 text-sm sm:text-base md:text-lg max-w-md text-center mt-3 sm:mt-4 px-4 font-light leading-relaxed">
